...
recipes.addShapeless(<rftools:button_module>, [<rftools:button_module>]);
...
recipes.addHiddenShapeless("Powercell Card", <rftools:powercell_card>, [<rftools:powercell_card>]);
