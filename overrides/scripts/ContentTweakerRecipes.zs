...
mods.thaumcraft.Infusion.registerRecipe("contenttweaker:RainbowTablet", "INFUSION", <contenttweaker:rainbow_tablet> * 32, 8, [<aspect:victus> * 99, <aspect:ignis> * 99, <aspect:sol> * 99, <aspect:herba> * 99, <aspect:instrumentum> * 99, <aspect:praecantatio> * 99], <contenttweaker:rainbow_slate>, [<botania:manaresource:14>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<botania:manaresource:14>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>,<bloodmagic:blood_shard>]);
