...
[<contenttweaker:white_matter>, <appliedenergistics2:dense_energy_cell>, <draconicevolution:draconium_capacitor:2>, <projecte:item.pe_klein_star:5>, <thermalexpansion:capacitor:32000>.withTag({Energy: 25000000}).only(function(stack as IItemStack) as bool { return true; }), <appliedenergistics2:dense_energy_cell>, <contenttweaker:white_matter>],
