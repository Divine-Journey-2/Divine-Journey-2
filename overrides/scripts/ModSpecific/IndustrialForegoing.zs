...
<industrialforegoing:mob_duplicator>.addTooltip(game.localize("dj2.mob_duplicator.desc0"));
<industrialforegoing:mob_duplicator>.addTooltip(game.localize("dj2.mob_duplicator.desc1"));
