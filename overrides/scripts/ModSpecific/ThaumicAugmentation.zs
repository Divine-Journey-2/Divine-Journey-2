...
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("thaumicaugmentation:glass_tube", "GLASS_TUBE", 10, [<aspect:aqua> * 4,<aspect:aer> * 3], <thaumicaugmentation:glass_tube> * 16, [[<enderio:item_alloy_ingot:6>,<simplyjetpacks:metaitemmods:12>,<enderio:item_alloy_ingot:6>],[<enderio:block_fused_glass>,<contenttweaker:rune_of_water>,<enderio:block_fused_glass>],[<enderio:item_alloy_ingot:6>,<simplyjetpacks:metaitemmods:12>,<enderio:item_alloy_ingot:6>]]);

// Warding Sigil
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:material:1>);
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:warding_sigil", "WARDED_ARCANA", <thaumicaugmentation:material:1>, 5, [<aspect:vinculum> * 100,<aspect:auram> * 50,<aspect:praecantatio> * 50,<aspect:instrumentum> * 20], <thaumcraft:seal>, [<thaumcraft:plate:2>,<thaumcraft:plate:2>,<thaumcraft:tallow>,<thaumcraft:plate:2>,<thaumcraft:plate:2>,<contenttweaker:infused_magical_core>]);

// Fortified Glass
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:fortified_glass>);
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("thaumicaugmentation:fortified_glass", "FORTIFIED_GLASS", 40, [<aspect:ordo> * 8,<aspect:aer> * 8,<aspect:aqua> * 8,<aspect:terra> * 8], <thaumicaugmentation:fortified_glass> * 8, [[<botania:elfglass>,<botania:elfglass>,<botania:elfglass>],[<botania:elfglass>,<thaumicaugmentation:material:1>,<botania:elfglass>],[<botania:elfglass>,<botania:elfglass>,<botania:elfglass>]]);
...
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:impetus_cell", "RIFT_POWER", <thaumicaugmentation:material:3>, 8, [<aspect:alienis> * 240,<aspect:vacuos> * 240,<aspect:potentia> * 240], <enderutilities:enderpart:17>, [<contenttweaker:impetus_crystal>,<thaumcraft:amber_block>,<contenttweaker:impetus_crystal>,<contenttweaker:condensed_vis_crystal_vacuos>,<contenttweaker:impetus_crystal>,<thaumcraft:amber_block>,<contenttweaker:impetus_crystal>,<contenttweaker:condensed_vis_crystal_alienis>]);

// Impetus Conductor
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:augment_caster_rift_energy_storage>);
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("thaumicaugmentation:augment_caster_rift_energy_storage", "RIFT_POWER", 100, [<aspect:perditio> * 32,<aspect:terra> * 8,<aspect:ignis> * 8], <thaumicaugmentation:augment_caster_rift_energy_storage>, [[<bewitchment:ectoplasm>,<thaumcraft:plate:2>,<bewitchment:ectoplasm>],[<thaumcraft:plate:2>,<thaumicaugmentation:material:3>,<thaumcraft:plate:2>],[<bewitchment:ectoplasm>,<thaumcraft:plate:2>,<bewitchment:ectoplasm>]]);
...
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:thaumostatic_harness_augment:1", "THAUMOSTATIC_GIRDLE", <thaumicaugmentation:thaumostatic_harness_augment:1>, 7, [<aspect:aer> * 100,<aspect:motus> * 75,<aspect:volatus> * 50], <thaumcraft:baubles:6>, [<contenttweaker:magical_leather>,<contenttweaker:travelers_tenacity>,<contenttweaker:magical_leather>,<contenttweaker:condensed_vis_crystal_volatus>]);

// Gyroscope Upgrade
mods.thaumcraft.Infusion.removeRecipe(<thaumicaugmentation:thaumostatic_harness_augment:0>);
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:thaumostatic_harness_augment:0", "THAUMOSTATIC_GYROSCOPE", <thaumicaugmentation:thaumostatic_harness_augment:0>, 7, [<aspect:vinculum> * 100,<aspect:aer> * 75,<aspect:volatus> * 50], <thaumcraft:baubles:6>, [<thaumcraft:plate:2>,<bewitchment:stone_ichor>,<thaumcraft:plate:2>,<contenttweaker:condensed_vis_crystal_vinculum>]);

// Fracture Locator
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:fracture_locator>);
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:fracture_locator", "ENTERING_FRACTURE", <thaumicaugmentation:fracture_locator>, 8, [<aspect:vacuos> * 240,<aspect:auram> * 200,<aspect:perditio> * 100], <contenttweaker:impetus_crystal>, [<thaumcraft:plate>,<contenttweaker:condensed_vis_crystal_vacuos>,<thaumcraft:plate>,<thaumcraft:nugget:10>,<thaumcraft:plate>,<contenttweaker:condensed_vis_crystal_vacuos>,<thaumcraft:plate>,<thaumcraft:nugget:10>]);
...
mods.thaumcraft.Crucible.registerRecipe("thaumicaugmentation:impetus_jewel", "IMPETUS", <thaumicaugmentation:material:5>, <contenttweaker:impetus_crystal>, [<aspect:ordo> * 40, <aspect:potentia> * 40,<aspect:stellae> * 10]);

// Impetus Drainer
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:impetus_drainer>);
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:impetus_drainer", "IMPETUS", <thaumicaugmentation:impetus_drainer>, 7, [<aspect:alienis> * 200,<aspect:machina> * 200,<aspect:potentia> * 100,<aspect:metallum> * 100,<aspect:auram> * 50], <thaumicaugmentation:material:5>, [<thaumcraft:plate:3>,<thaumcraft:plate:3>,<thaumcraft:stone_eldritch_tile>,<thaumicaugmentation:bars>,<thaumcraft:stone_eldritch_tile>,<thaumcraft:plate:3>,<thaumcraft:plate:3>,<thaumcraft:metal_void>]);

// Impetus Relay
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:impetus_relay>);
mods.thaumcraft.ArcaneWorkbench.registerShapelessRecipe("thaumicaugmentation:impetus_relay", "IMPETUS", 50, [<aspect:ignis> * 6,<aspect:ordo> * 6,<aspect:perditio> * 6,<aspect:terra> * 6], <thaumicaugmentation:impetus_relay>, [<thaumicaugmentation:material:5>,<thaumcraft:plate:3>]);

// Impetus Resonator
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:impetus_linker>);
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("thaumicaugmentation:impetus_linker", "IMPETUS", 150, [<aspect:ordo> * 8,<aspect:perditio> * 8,<aspect:ignis> * 4,<aspect:terra> * 4,<aspect:aer> * 4], <thaumicaugmentation:impetus_linker>, [[null,<thaumicaugmentation:material:5>,<thaumcraft:ingot:1>],[<thaumcraft:ingot:1>,<bewitchment:boline>,<thaumcraft:ingot:1>],[null,<thaumcraft:ingot:1>,null]]);

// Impetus Diffuser
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:impetus_diffuser>);
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:impetus_diffuser", "IMPETUS", <thaumicaugmentation:impetus_diffuser>, 8, [<aspect:alienis> * 200,<aspect:machina> * 200,<aspect:permutatio> * 100,<aspect:metallum> * 100,<aspect:auram> * 50], <thaumicaugmentation:material:5>, [<thaumcraft:morphic_resonator>,<thaumcraft:plate:3>,<thaumcraft:stone_eldritch_tile>,<botania:hourglass>,<thaumcraft:stone_eldritch_tile>,<thaumcraft:plate:3>,<thaumcraft:morphic_resonator>,<thaumcraft:plate:3>]);
...
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:autocaster_placer", "AUTOCASTER", <thaumicaugmentation:autocaster_placer>, 8, [<aspect:machina> * 200,<aspect:aversio> * 200,<aspect:cognitio> * 150,<aspect:sensus> * 50,<aspect:auram> * 50], <thaumcraft:mind:1>, [<thaumcraft:morphic_resonator>,<thaumcraft:vis_resonator>,<thaumcraft:plate>,<thaumcraft:mechanism_complex>,<thaumcraft:plate>,<thaumcraft:vis_resonator>,<thaumcraft:morphic_resonator>,<thaumicaugmentation:gauntlet:1>]);

// Flux Inducer
mods.thaumcraft.Infusion.removeRecipe(<thaumicaugmentation:rift_feeder>);
mods.thaumcraft.Infusion.registerRecipe("thaumicaugmentation:rift_feeder", "RIFT_FEEDER", <thaumicaugmentation:rift_feeder>, 7, [<aspect:machina> * 200,<aspect:vitium> * 200,<aspect:alienis> * 100,<aspect:vacuos> * 50,<aspect:perditio> * 50], <thaumcraft:essentia_input>, [<thaumcraft:mechanism_simple>,<thaumcraft:tube_filter>,<thaumcraft:plate:3>,<thaumcraft:morphic_resonator>,<thaumcraft:plate:3>,<thaumcraft:tube_filter>,<thaumcraft:mechanism_simple>,<thaumcraft:morphic_resonator>]);

// Reinforced Jar
mods.thaumcraft.ArcaneWorkbench.removeRecipe(<thaumicaugmentation:rift_jar>);
mods.thaumcraft.ArcaneWorkbench.registerShapedRecipe("thaumicaugmentation:rift_jar", "RIFT_MOVING", 50, [<aspect:aqua> * 20,<aspect:perditio> * 5], <thaumicaugmentation:rift_jar>, [[<thaumcraft:plate:3>,<thaumicaugmentation:material:1>,<thaumcraft:plate:3>],[<thaumcraft:plate:3>,<thaumcraft:jar_normal>,<thaumcraft:plate:3>],[<thaumcraft:plate:3>,<thaumcraft:plate:3>,<thaumcraft:plate:3>]]);
