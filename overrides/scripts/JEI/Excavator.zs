...
static dimensionIdentifier as string[int] = {
    -11325: game.localize("dj2.excavator.dimension.deep_dark"),
    -31:    game.localize("dj2.excavator.dimension.venus"),
    -30:    game.localize("dj2.excavator.dimension.asteroids"),
    -29:    game.localize("dj2.excavator.dimension.mars"),
    -28:    game.localize("dj2.excavator.dimension.moon"),
    -9:     game.localize("dj2.excavator.dimension.underworld"),
    -1:     game.localize("dj2.excavator.dimension.nether"),
    ...
    66:     game.localize("dj2.excavator.dimension.erebus"),
...
static rarityTable as string[][int] = {
     5: ["6", game.localize("dj2.excavator.rarity.extremely_rare")],
    10: ["6", game.localize("dj2.excavator.rarity.rare")],
    15: ["2", game.localize("dj2.excavator.rarity.uncommon")],
    20: ["2", game.localize("dj2.excavator.rarity.uncommon")],
    25: ["f", game.localize("dj2.excavator.rarity.common")],
    30: ["f", game.localize("dj2.excavator.rarity.common")],
    35: ["f", game.localize("dj2.excavator.rarity.very_common")],
    50: ["f", game.localize("dj2.excavator.rarity.extremely_common")],
} as string[][int];
