...
var inferiumcrystal = VanillaFactory.createItem("inferiumcrystal");
inferiumcrystal.maxStackSize = 1;
inferiumcrystal.maxDamage = 1023;
inferiumcrystal.register();
var prudentiumcrystal = VanillaFactory.createItem("prudentiumcrystal");
prudentiumcrystal.maxStackSize = 1;
prudentiumcrystal.maxDamage = 511;
prudentiumcrystal.register();
var intermediumcrystal = VanillaFactory.createItem("intermediumcrystal");
intermediumcrystal.maxStackSize = 1;
intermediumcrystal.maxDamage = 255;
intermediumcrystal.register();
var superiumcrystal = VanillaFactory.createItem("superiumcrystal");
superiumcrystal.maxStackSize = 1;
superiumcrystal.maxDamage = 127;
superiumcrystal.register();
var supremiumcrystal = VanillaFactory.createItem("supremiumcrystal");
supremiumcrystal.maxStackSize = 1;
supremiumcrystal.maxDamage = 63;
supremiumcrystal.register();
